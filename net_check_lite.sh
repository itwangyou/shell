...
local rdomain
# 精简版：江苏、上海、河南
rdomain[1]="js-ct-v$ipv.ip.zstaticcdn.com"
rdomain[2]="js-cu-v$ipv.ip.zstaticcdn.com"
rdomain[3]="js-cm-v$ipv.ip.zstaticcdn.com"
rdomain[4]="sh-ct-v$ipv.ip.zstaticcdn.com"
rdomain[5]="sh-cu-v$ipv.ip.zstaticcdn.com"
rdomain[6]="sh-cm-v$ipv.ip.zstaticcdn.com"
rdomain[7]="ha-ct-v$ipv.ip.zstaticcdn.com"
rdomain[8]="ha-cu-v$ipv.ip.zstaticcdn.com"
rdomain[9]="ha-cm-v$ipv.ip.zstaticcdn.com"
...
echo -ne "\r$Font_Cyan江苏TCP：$Font_Green电信 $Font_Suffix${routww[1]}$Font_Green->$Font_Suffix${routcn[1]} || $Font_Green联通$Font_Suffix $Font_Suffix${routww[3]}$Font_Green->$Font_Suffix${routcn[3]} || $Font_Green移动$Font_Suffix $Font_Suffix${routww[5]}$Font_Green->$Font_Suffix${routcn[5]}\n"
echo -ne "\r$Font_Cyan江苏UDP：$Font_Green电信 $Font_Suffix${routww[2]}$Font_Green->$Font_Suffix${routcn[2]} || $Font_Green联通$Font_Suffix $Font_Suffix${routww[4]}$Font_Green->$Font_Suffix${routcn[4]} || $Font_Green移动$Font_Suffix $Font_Suffix${routww[6]}$Font_Green->$Font_Suffix${routcn[6]}\n"
...
echo -ne "\r$Font_Cyan河南TCP：$Font_Green电信 $Font_Suffix${routww[13]}$Font_Green->$Font_Suffix${routcn[13]} || $Font_Green联通$Font_Suffix $Font_Suffix${routww[15]}$Font_Green->$Font_Suffix${routcn[15]} || $Font_Green移动$Font_Suffix $Font_Suffix${routww[17]}$Font_Green->$Font_Suffix${routcn[17]}\n"
echo -ne "\r$Font_Cyan河南UDP：$Font_Green电信 $Font_Suffix${routww[14]}$Font_Green->$Font_Suffix${routcn[14]} || $Font_Green联通$Font_Suffix $Font_Suffix${routww[16]}$Font_Green->$Font_Suffix${routcn[16]} || $Font_Green移动$Font_Suffix $Font_Suffix${routww[18]}$Font_Green->$Font_Suffix${routcn[18]}\n"
else
local tmppv=""
local tmpfont=""
local tmpback=""
...
# 精简版：跳过圣保罗(51)、悉尼(21)、纽约(32)、伦敦(42)
[[ $code -eq 51 || $code -eq 21 || $code -eq 32 || $code -eq 42 ]] && continue
if [[ $YY == "cn" ]];then
icity["$code"]="$cityzh"
else
icity["$code"]="$city"
...
# 精简版省份配置：仅保留上海、江苏、河南
RESPONSE='[
  {"code":"SH","short":"沪","zipcode":310000,"name":"上海市","province":31},
  {"code":"JS","short":"苏","zipcode":320000,"name":"江苏省","province":32},
  {"code":"HA","short":"豫","zipcode":410000,"name":"河南省","province":41}
]'
